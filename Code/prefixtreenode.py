...
class PrefixTreeNode:
    ...
    def has_child(self, character):
        ...
        return character in self.children #returns boolean
    ...
    def add_child(self, character, child_node):
        ...
        if not self.has_child(character):
            ...
            self.children[character] = child_node #You're inserting it into the dictionary3
        else:
